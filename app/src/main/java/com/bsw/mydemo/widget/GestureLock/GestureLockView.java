...
public class GestureLockView extends View {
     ...
     */
    enum Mode {
        STATUS_NO_FINGER, STATUS_FINGER_ON, STATUS_FINGER_UP_TRUE, STATUS_FINGER_UP_FALSE
    }
    ...
    private int mColorFingerUpTrue;
    private int mColorFingerUpFalse;

    public GestureLockView(Context context, int colorNoFingerInner, int colorNoFingerOutter, int colorFingerOn, int colorFingerUpTrue, int colorFingerUpFalse) {
        super(context);
        this.mColorNoFingerInner = colorNoFingerInner;
        this.mColorNoFingerOutter = colorNoFingerOutter;
        this.mColorFingerOn = colorFingerOn;
        this.mColorFingerUpTrue = colorFingerUpTrue;
        this.mColorFingerUpFalse = colorFingerUpFalse;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (mCurrentStatus) {
            ...
            case STATUS_FINGER_UP_TRUE:
                // 绘制外圆
                mPaint.setColor(mColorFingerUpTrue);
                mPaint.setStyle(Paint.Style.STROKE);
                mPaint.setStrokeWidth(2);
                canvas.drawCircle(mCenterX, mCenterY, mRadius, mPaint);
                // 绘制内圆
            ...
            case STATUS_FINGER_UP_FALSE:
                // 绘制外圆
                mPaint.setColor(mColorFingerUpFalse);
                mPaint.setStyle(Paint.Style.STROKE);
                mPaint.setStrokeWidth(2);
                canvas.drawCircle(mCenterX, mCenterY, mRadius, mPaint);
                // 绘制内圆
