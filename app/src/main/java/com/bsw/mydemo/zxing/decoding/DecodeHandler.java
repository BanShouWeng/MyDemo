...
package com.bsw.mydemo.zxing.decoding;
...
import com.bsw.mydemo.zxing.camera.PlanarYUVLuminanceSource;
...
final class DecodeHandler extends Handler {
	...
	private void decode(byte[] data, int width, int height) {
		...
		if (rawResult != null) {
			...
			Log.d(TAG, String.format("Found barcode (%d ms):\n%s", end - start, rawResult.toString()));
