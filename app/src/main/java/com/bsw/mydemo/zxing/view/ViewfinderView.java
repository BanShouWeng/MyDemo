...
package com.bsw.mydemo.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        try {
            ...
            @SuppressLint("DrawAllocation") Rect frame1 = new Rect();
            ...
            if (resultBitmap != null) {
                ...
                canvas.drawText("将二维码放入框内，即可快速扫描", rect.centerX(), rect.centerY(), paint);
