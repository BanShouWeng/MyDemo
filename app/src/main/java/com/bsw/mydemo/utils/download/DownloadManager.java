package com.bsw.mydemo.utils.download;
...
public class DownloadManager {
    ...
    private DownloadInfo getRealFileName(DownloadInfo downloadInfo) {
        ...
        File path = new File(FileUtils.FILE_PATH);
        if (!path.exists()) {
            path.mkdir();
        }
        File file = new File(FileUtils.FILE_PATH, fileName);
        if (file.exists()) {
        ...
        while (downloadLength >= contentLength) {
            ...
            File newFile = new File(FileUtils.FILE_PATH, fileNameOther);
            file = newFile;
    ...
    private class DownloadSubscribe implements ObservableOnSubscribe<DownloadInfo> {
        ...
        public void subscribe(ObservableEmitter<DownloadInfo> e) throws Exception {
            ...
            Request request = new Request.Builder()
                    ...
                    .addHeader("Cookie","acw_tc=2760821e15663564134003547e19a2d1f0fd9f51e42e8a0edde662caff7a0b; language=zh; USER_TOKEN=5baddf46-6039-4fde-be26-1700597b04dd")
                    .url(url)
                    .build();
            ...
            File file = new File(FileUtils.FILE_PATH, downloadInfo.getFileName());
            InputStream is = null;
