    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.navigation_baidu:
                PackageUtils.jumpTo(context, PackageUtils.BAIDU_MAP, StringFormatUtils.getString(lng), StringFormatUtils.getString(lat));
                break;

            case R.id.navigation_gaode:
                PackageUtils.jumpTo(context, PackageUtils.GAODE_MAP, StringFormatUtils.getString(lng), StringFormatUtils.getString(lat));
                break;
        }
    }
}
